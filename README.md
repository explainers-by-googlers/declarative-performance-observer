...
- [Detailed design discussion](#detailed-design-discussion)
  - [Deferred Reporting for Early Failures (capture-early-failures)](#deferred-reporting-for-early-failures-capture-early-failures)
...
![High-level workflow how entries are managed](https://github.com/user-attachments/assets/45f85919-a8a5-43e7-87eb-4082db74f48f)
